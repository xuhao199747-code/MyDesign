(function registerPhotoRevealModule() {
  ...
  function initPhotoReveal(options = {}) {
    ...
    const photoElements = siteSections.getHomeSectionElements?.().photo || {};
    const photoSection = photoElements.section || queryElement("#photo");
    const photoImagesWrap =
      photoElements.imagesWrap || queryElement("#photo .photo-images");
    const frontPhotoImage =
      photoElements.frontImage || queryElement("#photo .photo-image-front");
