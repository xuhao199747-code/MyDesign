(function registerSiteConfig() {
  ...
  const siteConfig = {
    ...
    homeContent: {
      ...
      featured: {
        ...
        cards: [
          {
            title: "组件库",
            href: "https://shadcn-docs-six.vercel.app/",
            image: "./imag/loding-app-card.webp",
            alt: "组件库项目",
            description: "组件规范与文档系统，用更清晰的结构组织设计语言。",
          },
          {
            title: "猪猪黄昏",
            href: "https://pigpig.vercel.app/",
            image: "./imag/pigpig-card.webp",
            alt: "猪猪黄昏项目",
            description: "轻松有趣的小应用，用角色和反馈制造记忆点。",
          },
          {
            title: "LODING",
            href: "https://loding-five.vercel.app/",
            image: "./imag/loding-five-card.webp",
            alt: "LODING 项目",
            description: "加载动效实验，把等待过程变成更有节奏的体验。",
          },
          {
            title: "PORTRAIT",
            ...
            image: "./imag/photo2.webp",
            alt: "PORTRAIT 项目",
            description: "人物视觉实验，突出氛围、裁切和轻交互反馈。",
          },
          {
            title: "BRAIN UI",
            href: "#portfolio-featured",
            image: "./imag/frame_front.webp",
            alt: "BRAIN UI 项目",
            description: "把抽象想法视觉化，形成更有识别度的内容表达。",
          },
          {
            title: "SNEAKERS",
            href: "#portfolio-featured",
            image: "./imag/design top.webp",
            alt: "SNEAKERS 项目",
            description: "电商活动视觉概念，强调产品节奏和转化路径。",
          },
          {
            title: "Agent执行流程",
            href: "https://logic-flow-diagram.vercel.app/",
            image: "./imag/agent-flow-card.png",
            alt: "Agent执行流程项目",
            description: "可视化 Agent 从接收任务到执行完成的完整流程。",
          },
        ],
      },
    },
    ...
    logoPhysics: {
      ...
      sideDamp: 0.55,
      rotationDamp: 0.88,
      collisionMinDistRatio: 0.82,
      collisionRestitution: 0.18,
      mobileSpreadLift: 8,
      desktopSpreadLift: 14,
      startYMobileMax: 240,
