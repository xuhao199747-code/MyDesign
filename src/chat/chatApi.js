export const fallbackPublicConfig = {
  ...
  knowledgeItems: [
    ...
    },
    {
      ...
      answer: "徐浩的核心优势包括：AI 产品从 0 到 1，以“AI＋业务场景”双视角兼顾 C 端需求与 B 端逻辑，完成场景拆解、模型选型、MVP 和 PE；深入客户业务一线，将需求转化为产品规划和行业解决方案；具备 UI/UX 设计判断；熟练使用 IDE、编程类 Agent 和 Dify 进行 Vibe Coding 快速验证；理解 RAG、Multi-Agent、Loop、Graph、MCP 等 AI 技术栈；能够通过数据归因和评测体系持续优化产品效果。",
    },
    {
      id: "skills",
      enabled: true,
    ...
    },
    {
      ...
      answer: "2024 年 11 月至今，徐浩在阿里云 MaaS 项目制团队担任 AI 产品经理。主要负责 AI 底层产品能力建设、多智能体协同架构、GEO 品牌增长平台和智能营销全链路能力，核心能力复用率超过 80%，整体营销人效提升 40%+，并联动研发、算法和业务团队完成产品从方案验证到上线落地。",
    },
    {
      id: "saixinghang",
      enabled: true,
    ...
    },
    {
      ...
      answer: "AlphaRank 是面向品牌方和营销团队的品牌 AI 认知管理与 GEO 增长平台，解决品牌在 AI Search 中表现不可见、问题难定位、检索效果不稳定等问题。徐浩参与平台从 0 到 1 建设，搭建“数据采集与指标层—知识资产层—Agent 编排与工具层—GEO 应用层”架构，参与设计“Leader Agent＋六类专业 Agent”协作体系，结合 RAG/LightRAG、混合检索、Rerank 和实体关系检索，使知识库检索准确率由 71.1% 提升至 85%+。",
    },
    {
      id: "lai-trip",
      enabled: true,
      ...
      answer: "Lai Trip 面向旅行社、定制游团队与旅游顾问，提供全链路数字化展业能力，以 Agent 协同串联“内容生产—商机挖掘—营销转化”，覆盖公域获客、私域沉淀、智能待客及转化出单。徐浩将旅游顾问的隐性销售经验转化为可编排能力，规划 Skill、Memory、MCP 能力分层，并建立“单技能级—流程级—业务级”三级评测链路，约 80% 的核心能力可复用于其他咨询转化及服务型场景。",
    },
    {
      id: "customer-service",
      enabled: true,
      ...
      answer: "徐浩主导企业智能客服 SaaS 平台从 0 到 1 搭建，负责智能问答、人工转接、知识运维和数据运营模块；设计标准化 RAG 知识处理流程，涵盖清洗、切片、Embedding、混合召回与重排，搭建“意图识别—检索生成—业务查询—异常兜底—人工接管”闭环问答工作流。项目问答准确率达到 82%+，AI 承接 60%+ 高频咨询。",
    },
    {
      id: "results",
      enabled: true,
      ...
      answer: "代表性成果包括：AI 产品核心能力复用率超过 80%；品牌 AI 最高提及率达到 95.1%，核心关键词平均排名前 2 位，正向内容覆盖率 100%；旅游营销整体人效提升 40%+；AlphaRank 知识库检索准确率由 71.1% 提升至 85%+；智能客服问答准确率达到 82%+，AI 承接 60%+ 高频咨询；Bad Case 首轮根因定位率由约 45% 提升至 80%，多人评审一致性由约 65% 提升至 90%，内容首轮准出率由约 55% 提升至 75%；累计参与落地 10+ 政企重点项目。",
    },
    {
      id: "method",
      enabled: true,
      ...
      answer: "徐浩以“AI＋业务场景”双视角推进产品设计，先拆解场景、用户任务和业务目标，再规划模型、知识库、Agent、工具及评测闭环。曾建立“单技能级—流程级—业务级”三级评测链路，通过标准测试集、Bad Case 归因和回归测试贯通模型能力、任务流程与业务结果；也结合 E-E-A-T、100 分制、6 个维度、15 个评分项及 4 档准出规则，统一内容评审标准。",
    },
    {
      id: "portfolio",
      enabled: true,
