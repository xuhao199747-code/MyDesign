export const fallbackPublicConfig = {
  ...
  knowledgeItems: [
    ...
    },
    {
      ...
      answer: "徐浩的核心优势包括：AI 产品从 0 到 1，以“AI＋业务场景”双视角兼顾 C 端需求与 B 端逻辑，完成场景拆解、模型选型、MVP 和 PE，围绕北极星指标平衡效果、成本与收益；深入客户业务一线，将需求转化为产品规划和行业解决方案；具备 UI/UX 设计背景和体验判断；熟练使用 IDE、编程类 Agent 及 Dify，结合上下文和 SDD 方法快速验证产品；深度理解 RAG、Multi-Agent、Loop、Graph、MCP 等 AI 技术栈；能够通过数据归因和评测体系持续优化产品效果。",
    },
    {
      id: "skills",
      enabled: true,
