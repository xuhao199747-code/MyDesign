...
export const MessageContent = ({ children, className, ...props }) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:border group-[.is-user]:border-black/10 group-[.is-user]:bg-white group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground",
